...
def report(book):
    """Add a summary entry and return total debits.

    Appends a 'report' debit entry with the current total_debits value,
    then returns the new total.
    ...
    Returns
    -------
    float — total debits after the summary entry is added.
    """
    d = total_debits(book)
    record_entry(book, {"name": "report", "type": "debit", "amount": d})
